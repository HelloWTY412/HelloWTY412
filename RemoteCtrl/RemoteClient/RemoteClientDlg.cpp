...
//7锁机
//8解锁
int CRemoteClientDlg::SendCommandPacket(int nCmd, bool Close, BYTE* pData,size_t nLength) {
...
{
	// TODO: 在此添加控件通知处理程序代码
	int ret=SendCommandPacket(1);//获取磁盘信息
	if (ret == -1) {
...
void CRemoteClientDlg::threadEntryForDownFule(void* arg)
{
...
{
	// TODO: 在此添加命令处理程序代码
	_beginthread(CRemoteClientDlg::threadEntryForDownFule, 0, this);
	BeginWaitCursor();
